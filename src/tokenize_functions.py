...
class Tokenizer:
    ...
    def tokenize_base(self, prompt, cutoff_len):
    ...
    # Notice: in the generate_and_tokenize_prompt function result["labels"] is rewritten
    def tokenize(self, prompt, cutoff_len):
        return self.tokenize_base(prompt, cutoff_len)
    ...
    def generate_and_tokenize_prompt(self, data_point):
        ...
        tokenized_user_prompt = self.tokenize(
            user_prompt, CUTOFF_LEN, add_eos_token=True
        )
